...
WEB_SERVER_SIGNATURES: dict[str, list[tuple[str, str, int]]] = {
    ...
    "IIS": [("header_value", "iis", 95), ("header_value", "microsoft-iis", 95)],
...
LANGUAGE_SIGNATURES: dict[str, list[tuple[str, str, int]]] = {
    "PHP": [("header_value", "php", 90), ("cookie_name", "phpsessid", 85)],
    "Python": [("header_value", "python", 90), ("header_value", "werkzeug", 85)],
    "Ruby": [("header_value", "ruby", 90), ("header_value", "passenger", 85)],
    "Java": [("header_value", "java", 90), ("cookie_name", "jsessionid", 85)],
    "ASP.NET": [
        ("header_value", "asp.net", 90),
...
ANALYTICS_SIGNATURES: dict[str, list[tuple[str, str, int]]] = {
    ...
    "Matomo": [("html_substring", "matomo.js", 90), ("html_substring", "piwik.js", 90)],
}
